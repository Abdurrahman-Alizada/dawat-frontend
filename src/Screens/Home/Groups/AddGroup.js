import { TouchableOpacity, Text, Image, Pressable, StyleSheet, Modal, View } from 'react-native'
...
const AddGroup = ({navigation, onClose}) => {
  ...
  const submitHandler = (values) =>{
    dispatch(
      addGroup(
       { name: values.groupName , avatar_url:"https://bootdey.com/img/Content/avatar/avatar6.png"}
      )
    )
  ...
  return (
    ...
    <View style={{padding:'5%'}}>
      <Formik
        ...
        <Input
          placeholder='Optional' label="Enter Description" 
